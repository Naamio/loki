...
public class Filter {
    ...
    public init(_ target: Filter.TargetType, required: Bool, minLevel: LogLevel) {
...
public class CompareFilter: Filter, FilterType {
    ...
    override public init(_ target: Filter.TargetType, required: Bool, minLevel: LogLevel) {
...
public class FunctionFilterFactory {
    ...
    public static func custom(required: Bool = false, minLevel: LogLevel = .verbose, filterPredicate: @escaping (String) -> Bool) -> FilterType {
